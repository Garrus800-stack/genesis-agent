...
npm test           # Run all tests (652 suites, 9492 tests Win baseline)
...
| `npm test` | Run full test suite (legacy + per-module, 652 suites) |
...
```bash
npm test                              # All tests (547 suites, ~8505 tests)
