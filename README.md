<p align="center">
  ...
  <br><br>
  <img src="https://img.shields.io/badge/version-7.2.6_%22Event_Hygiene%22-d4a017?style=flat-square" alt="Version">
  ...
  <img src="https://img.shields.io/badge/modules-248-e0e0e8?style=flat-square" alt="Modules">
  <img src="https://img.shields.io/badge/services-154-fbbf24?style=flat-square" alt="Services">
  <img src="https://img.shields.io/badge/phases-12-c084fc?style=flat-square" alt="Phases">
  <img src="https://img.shields.io/badge/events-370-c084fc?style=flat-square" alt="Events">
...
Genesis boots 12 phases (~154 services). The former Consciousness Layer (Phase 13) was replaced by a lightweight AwarenessPort in v7.0.0.
...
Twelve layers with clear boundaries — star topology where every layer depends only on core/ and ports/, never on each other. The kernel is immutable. Critical safety files are hash-locked (16 files). Everything else is fair game for self-modification. v7.2.1: zero cross-layer violations, TSC clean, 11 PreservationInvariants rules, 4335 tests passing, 154 services. Self-Preservation Invariants prevent safety regression during self-modification.
...
| Metric | Value |
|---|---|
| Source modules | 221 agent modules (src/agent/) |
| Lines of code | ~73k src (agent) + ~52k test |
| Manifest phases | 12 (Phase 1–12, boot order enforced) |
| DI services | 142 manifest + 12 bootstrap = 154 at runtime |
| Late-bindings | 247 cross-phase dependency bindings |
| Test suites | 261 files, 4335 tests (coverage gates: 80/75.9/78) |
...
| Event types | 370 across ~90 namespaces (catalogued in EventTypes.js) |
| Event schemas | 370/370 (100% coverage, enforced by CI ratchet) |
