# Genesis Agent v7.9.3 — **Settings consistency pass: 22 dashboard/setting bugs fixed, 30 boot-only settings now show a restart hint, Architecture Graph opens in a fullscreen modal, Trust-level dropdown promises hold, Ollama embedding context size matches model capacity.**
