...
- 7231 tests on Windows / 7230 on Linux (passing, 0 failures)
- 460 events with 460 payload schemas (full parity)
...
| **437 test files** | 7231 tests (Win baseline, v7.7.9), coverage gates: 80% lines, 76% branches, 78% functions |
