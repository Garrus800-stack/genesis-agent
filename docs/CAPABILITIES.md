...
- 6943 tests on Windows / 6942 on Linux (passing, 0 failures)
- 455 events with 455 payload schemas (full parity)
...
| **419 test files** | 6943 tests (Win baseline, v7.7.6), coverage gates: 80% lines, 76% branches, 78% functions |
