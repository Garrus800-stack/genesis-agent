...
- 383 source modules across 12 boot phases
- 180 DI services (167 manifest + 13 bootstrap)
- 8105 tests on Windows / 7932 on Linux (passing, 0 failures)
- 492 events with 492 payload schemas (full parity)
...
| **523 test files** | 8105 tests (Win baseline, v7.9.6), coverage gates: 80% lines, 76% branches, 78% functions |
