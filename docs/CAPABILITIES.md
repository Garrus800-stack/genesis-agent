...
- 7577 tests on Windows / 7576 on Linux (passing, 0 failures)
- 463 events with 463 payload schemas (full parity)
...
| **461 test files** | 7577 tests (Win baseline, v7.8.8), coverage gates: 80% lines, 76% branches, 78% functions |
