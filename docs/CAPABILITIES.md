...
- 7794 tests on Windows / 7793 on Linux (passing, 0 failures)
- 476 events with 476 payload schemas (full parity)
...
| **479 test files** | 7794 tests (Win baseline, v7.9.1), coverage gates: 80% lines, 76% branches, 78% functions |
