...
- **491 event types** catalogued in `EventTypes.js` (v7.9.12 baseline)
- **491 payload schemas** in `EventPayloadSchemas.js` — full parity since v7.6.x (every catalog entry has a registered schema); dev-mode validation throws on mismatch
