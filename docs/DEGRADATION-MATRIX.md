...
Generated: 2026-07-30T16:32:06.896Z
Services: 172 | Bindings: 701
...
| knowledgeGraph | P1 | 20 | uncertaintyGuard, embeddingService, kg, promptBuilder, shellAgent, mcpClient, anticipator, solutionAccumulator, unifiedMemory, learningService, idleMind, homeostasis, agentLoop, failureAnalyzer, emotionalFrontier, unfinishedWorkFrontier, dreamCycle, suspicionFrontier, lessonFrontier, graphReasoner |
...
| lessonsStore | P9 | 2 | selfModOutcomeTracker, lessonsAutoCapture |
...
| embeddingService | P1 | 2 | trajectoryCalibration.embeddingService, skillCrystallizer.embeddingService |
| moduleSigner | P1 | 1 | promptEvolution.moduleSigner |
| preservation | P1 | 1 | selfModPipeline._preservation |
| costGuard | P1 | 3 | llm._costGuard, commandHandlers.costGuard, quickBenchmark.costGuard |
...
| journalWriter | P9 | 4 | idleMind.journalWriter, contextCollector.journalWriter, dreamCycle.journalWriter, wakeUpRoutine.journalWriter |
...
| selfStatementLog | P9 | 5 | promptBuilder.selfStatementLog, shellAgent.selfStatementLog, commandHandlers.selfStatementLog, agentLoop.selfStatementLog, innerSpeech._selfStatementLog |
| proactiveSelfExpression | P9 | 2 | commandHandlers.proactiveSelfExpression, concernMonitor.proactiveSelfExpression |
...
| selfTrajectory | P9 | 2 | commandHandlers.selfTrajectory, trajectoryCalibration.selfTrajectory |
| eventCounter | P9 | 2 | selfTrajectory.eventCounter, trajectoryCalibration.eventCounter |
| trajectoryCalibration | P9 | 1 | commandHandlers.trajectoryCalibration |
...
| cognitiveSelfModel | P9 | 7 | promptBuilder.cognitiveSelfModel, commandHandlers.cognitiveSelfModel, idleMind._cognitiveSelfModel, selfTrajectory.cognitiveSelfModel, trajectoryCalibration.cognitiveSelfModel, adaptiveStrategy.cognitiveSelfModel, goalSynthesizer.selfModel |
...
| adaptiveStrategy | P9 | 1 | commandHandlers.adaptiveStrategy |
...
| preSleep | P9 | 1 | wakeUpRoutine.preSleep |
...
| userModel | P10 | 4 | promptBuilder.userModel, disclosurePolicy.userModel, needsSystem.userModel, concernMonitor.userModel |
| trustLevelSystem | P11 | 11 | tools._trustLevelSystem, disclosurePolicy.trustLevelSystem, shellAgent.trustLevelSystem, commandHandlers.trustLevel, commandHandlers.trustLevelSystem, daemon.trustLevelSystem, idleMind._trustLevelSystem, bodySchema.trustLevelSystem, agentLoop.trustLevelSystem, earnedAutonomy.trustLevelSystem, effectorRegistry.trustLevel |
| earnedAutonomy | P11 | 1 | commandHandlers.earnedAutonomy |
...
| selfModOutcomeTracker | P9 | cognitive, learning |
| concernMonitor | P9 | cognitive, self, relationship |
| stalledGoalWatchdog | P9 | cognitive, goals, lifecycle |
| kindTriggers | P9 | cognitive, self-expression, triggers |
| changeRegister | P9 | cognitive, persistent, observer |
