...
The code defines what Genesis *can* do: hundreds of source files, ~185 services, 12 boot phases, 498 event types. The code is the same on every machine that runs Genesis. You can clone it from GitHub and have a running agent in a few minutes.
