...
const FUZZY_BY_DESIGN = {
  ...
  'vestibule-status': 'the knock itself — called by OUTSIDE visitors over the MCP door, never by the partner in chat; a slash command would aim the wrong way (v7.9.46).',
  'vestibule-voice': 'his voice file is written in his own moment (first-opening ritual), not on partner demand — no slash by design (v7.9.46).',
  'vestibule-circle': 'circle decisions are HIS sovereignty over relationships; surfacing a slash would invite the partner to steer them (v7.9.46).',
