...
// ── Step 0: Regenerate generated docs ────────────────────
//
// v7.6.3 carry-over: the v7.6.3 ZIP shipped with a stale
// DEGRADATION-MATRIX.md (155 services / 592 bindings vs live
// 605 bindings). The matrix is auto-generated by
// scripts/degradation-matrix.js — running it as part of release
// guarantees every release ships a fresh inventory rather than
// whatever the working tree happens to have.

console.log('── Step 0: Regenerating Generated Docs ──\n');

try {
  execFileSync('node', ['scripts/degradation-matrix.js', '--md', '--out'], {
    cwd: ROOT,
    stdio: 'pipe',
    encoding: 'utf-8',
  });
  console.log('  ✅ docs/DEGRADATION-MATRIX.md regenerated\n');
} catch (err) {
  console.error('  ⚠  degradation-matrix regeneration failed:', err.message);
  console.error('     Continuing — the existing matrix will ship as-is.\n');
}
