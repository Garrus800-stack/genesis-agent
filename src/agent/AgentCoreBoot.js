...
const { safeJsonParse } = require('./core/utils');
 const { agentCoreBootWireMixin } = require('./AgentCoreBootWire'); // v7.9.29 (hygiene #1)
...
Object.assign(AgentCoreBoot.prototype, agentCoreBootWireMixin); // v7.9.29 (hygiene #1)
