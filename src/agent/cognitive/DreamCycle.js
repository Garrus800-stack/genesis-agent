...
// v7.3.9: Phase methods extracted to DreamCyclePhases.js to keep
// this file under the 700-LOC threshold. Same prototype-delegation
// pattern. External API unchanged.
const { dreamCyclePhases } = require('./DreamCyclePhases');
Object.assign(DreamCycle.prototype, dreamCyclePhases);
