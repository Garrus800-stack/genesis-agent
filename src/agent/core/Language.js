...
const STRINGS = {
  en: {
    ...
    'goals.steps': 'Steps',
    'goals.empty': 'No goals set yet. Say e.g. "Set goal: Improve error handling"',
    'goals.title': 'Goals',
  ...
  de: {
    ...
    'goals.empty': 'Noch keine Ziele gesetzt. Sage z.B. "Setze Ziel: Bessere Fehlerbehandlung einbauen"',
    'goals.title': 'Ziele',
