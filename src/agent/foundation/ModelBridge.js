...
const { modelBridgeDispatch } = require('./ModelBridgeDispatch'); // v7.9.50
...
class ModelBridge {
  ...
  // v7.9.50: _dispatch and everything around it — the two entry points, the
  // model resolution, the meta-learning record and the stats readers — live
  // in ModelBridgeDispatch.js and are mixed onto the prototype below.
...
Object.assign(ModelBridge.prototype, availability, discovery, failoverMixin, contextMixin, continuationMixin, modelBridgeDispatch);
