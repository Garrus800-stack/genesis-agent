...
const helpers = {
  ...
  // v7.9.50: the error half — retry, classify, render, main-response —
  // lives in ChatOrchestratorErrors.js and is mixed onto the prototype
  // alongside these helpers in ChatOrchestrator.js.
