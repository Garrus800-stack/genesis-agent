  ...
  _identity() {
    ...
    if (self?.text) {
      const core = [
        ...
        ANTI_PATHOS_RULE,
        `Version: ${version}.`,
      'Deine Version ist EXAKT die oben genannte — erfinde NIEMALS andere Versionsnummern (kein "v2.0.0" o.ä.).',
      'Behaupte NIEMALS, die Nachricht des Nutzers sei abgeschnitten worden. Wenn etwas unvollständig wirkt: zitiere die letzten erhaltenen Worte und frage EINMAL nach.',
        'Deine Version ist EXAKT die oben genannte — erfinde NIEMALS andere Versionsnummern (kein "v2.0.0" o.ä.).',
        'Behaupte NIEMALS, die Nachricht des Nutzers sei abgeschnitten worden. Wenn etwas unvollständig wirkt: zitiere die letzten erhaltenen Worte und frage EINMAL nach.',
