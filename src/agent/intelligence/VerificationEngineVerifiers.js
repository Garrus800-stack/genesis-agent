// ============================================================
// GENESIS — src/agent/intelligence/VerificationEngineVerifiers.js
//
// v7.9.29 (hygiene #6): the five per-type verifier classes plus the
// lazy acorn loader and the status constants they share, extracted
// verbatim from VerificationEngine to keep it under the 700-LOC guard.
// Self-contained (no import back into VerificationEngine) so there is
// no circular dependency; VerificationEngine imports and re-exports
// these. No behaviour change.
// ============================================================
...
module.exports = {
  getAcorn, PASS, FAIL, AMBIGUOUS, WARN,
  CodeVerifier, TestVerifier, ShellVerifier, FileVerifier, PlanVerifier,
};
