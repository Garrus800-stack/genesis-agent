...
const { emotionalStateHistoryMixin } = require('./EmotionalStateHistory'); // v7.9.29 (hygiene #5)
...
Object.assign(EmotionalState.prototype, emotionalStateHistoryMixin); // v7.9.29 (hygiene #5)
