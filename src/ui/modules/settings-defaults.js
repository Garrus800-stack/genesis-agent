...
const FIELD_REGISTRY = {
  ...
  'set-openai-url':               { type: 'string',   settingsPath: 'models.openaiBaseUrl',            resetSafe: true,  default: '' },
  'set-openai-key':               { type: 'password', settingsPath: 'models.openaiApiKey',             resetSafe: false, default: '' },
  'set-openai-models':            { type: 'list',     settingsPath: 'models.openaiModels',             resetSafe: true,  default: [] },
  'set-preferred-model':          { type: 'string',   settingsPath: 'models.preferred',                resetSafe: true,  default: null },
  'set-role-chat':                { type: 'string',   settingsPath: 'models.roles.chat',               resetSafe: true,  default: null },
  'set-role-code':                { type: 'string',   settingsPath: 'models.roles.code',               resetSafe: true,  default: null },
  'set-role-analysis':            { type: 'string',   settingsPath: 'models.roles.analysis',           resetSafe: true,  default: null },
  'set-role-creative':            { type: 'string',   settingsPath: 'models.roles.creative',           resetSafe: true,  default: null },
  ...
  'set-trust-level':              { type: 'enum',     settingsPath: 'trust.level',                     resetSafe: true,  default: 1, options: [0,1,2,3] },
  ...
  'set-max-workers':              { type: 'number',   settingsPath: 'selfSpawner.maxWorkers',          resetSafe: true,  default: 3,    min: 1,    max: 10 },
  'set-keep-alive':               { type: 'string',   settingsPath: 'models.ollamaKeepAlive',          resetSafe: true,  default: null },
  'set-kg-max-nodes':             { type: 'number',   settingsPath: 'knowledgeGraph.maxNodes',         resetSafe: true,  default: 5000, min: 0,    max: 100000 },
  'set-sslog-max':                { type: 'number',   settingsPath: 'selfStatementLog.maxStatements', resetSafe: true,  default: 5000, min: 0,    max: 100000 },
  'set-approval-timeout':         { type: 'number',   settingsPath: 'timeouts.approvalSec',            resetSafe: true,  default: 60,   min: 10,   max: 3600 },
  ...
  'set-eventstore-size':          { type: 'number',   settingsPath: 'eventStore.maxFileSizeMB',        resetSafe: true,  default: 50,   min: 0,    max: 500 },
  'set-eventstore-rotations':     { type: 'number',   settingsPath: 'eventStore.maxRotations',         resetSafe: true,  default: 3,    min: 0,    max: 10 },
  'set-spawner-timeout':          { type: 'number',   settingsPath: 'selfSpawner.timeoutMs',           resetSafe: true,  default: 300,  min: 10,   max: 3600, _scaleMs: true },
  'set-spawner-memory':           { type: 'number',   settingsPath: 'selfSpawner.memoryLimitMB',       resetSafe: true,  default: 256,  min: 64,   max: 4096 },
  'set-workerpool-max':           { type: 'number',   settingsPath: 'workerPool.maxWorkers',           resetSafe: true,  default: 0,    min: 0,    max: 16 },
  'set-episodic-max':             { type: 'number',   settingsPath: 'episodicMemory.maxEpisodes',      resetSafe: true,  default: 500,  min: 0,    max: 50000 },
  'set-idlemind-journal-size':    { type: 'number',   settingsPath: 'idleMind.journalMaxFileSizeMB',   resetSafe: true,  default: 10,   min: 1,    max: 500 },
  ...
  'set-mcp-port':                 { type: 'number',   settingsPath: 'mcp.serve.port',                  resetSafe: true,  default: 3580, min: 1024, max: 65535 },

  // ── Erweitert ─────────────────────────────────────────
  'set-sim-branches':             { type: 'number',   settingsPath: 'cognitive.simulation.maxBranches', resetSafe: true, default: 3,   min: 1,    max: 20 },
  'set-sim-depth':                { type: 'number',   settingsPath: 'cognitive.simulation.maxDepth',    resetSafe: true, default: 15,  min: 1,    max: 100 },
  'set-emotion-decay-interval':   { type: 'number',   settingsPath: 'organism.emotions.decayIntervalMs', resetSafe: true, default: 60, min: 5,   max: 3600, _scaleMs: true },
  'set-loneliness-interval':      { type: 'number',   settingsPath: 'organism.emotions.lonelinessIntervalMs', resetSafe: true, default: 300, min: 30, max: 7200, _scaleMs: true },
  ...
  'set-daemon-cycle':             { type: 'number',   settingsPath: 'daemon.cycleMinutes',             resetSafe: true,  default: 5,    min: 1,    max: 120 },
  'set-health-http':              { type: 'bool',     settingsPath: 'health.httpEnabled',              resetSafe: true,  default: false },
  'set-health-port':              { type: 'number',   settingsPath: 'health.httpPort',                 resetSafe: true,  default: 9090, min: 1024, max: 65535 },
