...
function make() { return new Anticipator({ bus: { emit(){}, fire(...args) { return this.emit ? this.emit(...args) : undefined; }, on(){} }, memory: null, knowledgeGraph: null, eventStore: null, model: null }); }
