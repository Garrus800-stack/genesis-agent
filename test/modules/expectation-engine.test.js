...
function make() { return new ExpectationEngine({ bus: { emit(){} , fire(...args) { return this.emit ? this.emit(...args) : undefined; }}, metaLearning: null, schemaStore: null, worldState: null, storage: null, config: {} }); }
