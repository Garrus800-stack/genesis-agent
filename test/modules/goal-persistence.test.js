...
function make() { return new GoalPersistence({ bus: { emit(){}, on(){}, fire(...args) { return this.emit ? this.emit(...args) : undefined; } }, storage: { readJSON: ()=>null, writeJSON: ()=>{} }, goalStack: { getAll: ()=>[], goals: [] }, eventStore: { query: ()=>[] }, config: {} }); }
