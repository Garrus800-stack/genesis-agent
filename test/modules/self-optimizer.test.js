...
function make() { return new SelfOptimizer({ bus: { emit(){}, fire(...args) { return this.emit ? this.emit(...args) : undefined; }, on(){} }, eventStore: { query: ()=>[] }, memory: null, goalStack: { getAll: ()=>[] }, storageDir: os.tmpdir(), storage: { readJSON: ()=>null, writeJSON: ()=>{} } }); }
