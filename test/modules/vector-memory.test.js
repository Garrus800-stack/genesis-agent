...
function make() { return new VectorMemory({ bus: { emit(){}, fire(...args) { return this.emit ? this.emit(...args) : undefined; }, on(){} }, storage: { readJSON: ()=>null, writeJSONAsync: ()=>Promise.resolve() }, embeddingService: null }); }
